...
@genType
and entities = {
    @as("ContractTotals") contractTotals: entityStoreOperations<Entities.ContractTotals.t>,
    @as("SweepStakesNFTs_Enter") sweepStakesNFTs_Enter: entityStoreOperations<Entities.SweepStakesNFTs_Enter.t>,
    @as("SweepStakesNFTs_Transfer") sweepStakesNFTs_Transfer: entityStoreOperations<Entities.SweepStakesNFTs_Transfer.t>,
    @as("SweepStakesNFTs_Unstake") sweepStakesNFTs_Unstake: entityStoreOperations<Entities.SweepStakesNFTs_Unstake.t>,
    @as("SweepStakesNFTs_WinnerAssigned") sweepStakesNFTs_WinnerAssigned: entityStoreOperations<Entities.SweepStakesNFTs_WinnerAssigned.t>,
    @as("SweepStakesNFTs_Withdraw") sweepStakesNFTs_Withdraw: entityStoreOperations<Entities.SweepStakesNFTs_Withdraw.t>,
  ...
  let entities = {
      contractTotals: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.ContractTotals)),
          ~getKey=({id}) => id,
        )
      },
      sweepStakesNFTs_Enter: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SweepStakesNFTs_Enter)),
          ~getKey=({id}) => id,
        )
      },
      sweepStakesNFTs_Transfer: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SweepStakesNFTs_Transfer)),
          ~getKey=({id}) => id,
        )
      },
      sweepStakesNFTs_Unstake: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SweepStakesNFTs_Unstake)),
          ~getKey=({id}) => id,
        )
      },
      sweepStakesNFTs_WinnerAssigned: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SweepStakesNFTs_WinnerAssigned)),
          ~getKey=({id}) => id,
        )
      },
      sweepStakesNFTs_Withdraw: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SweepStakesNFTs_Withdraw)),
          ~getKey=({id}) => id,
        )
      },
      token: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.Token)),
          ~getKey=({id}) => id,
        )
      },
      user: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.User)),
          ~getKey=({id}) => id,
        )
      },
  }
